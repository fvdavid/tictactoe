...
class TicTacToe {
   ...
   public static final int ROWS = CountRowAndColumn.ROWS;
   public static final int COLS = CountRowAndColumn.COLS; // number of rows and columns
    ...
    */
   public static void playerMove(final int theSeed) {
      ...
      do {
         ...
         final int row = in.nextInt() - 1; // array index starts at 0 instead of 1
    ...
    */
   public static void updateGame(final int theSeed, final int currentRow, final int currentCol) {
    ...
    * (currentRow, currentCol)
    */
   public static boolean hasWon(final int theSeed, final int currentRow, final int currentCol) {
   ...
   public static void printCell(final int content) {
      switch (content) {
         case EMPTY:
            System.out.print("   ");
            break;
